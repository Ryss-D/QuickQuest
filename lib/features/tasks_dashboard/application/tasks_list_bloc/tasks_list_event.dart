...
class TasksListEvent with _$TasksListEvent{
  ...
  const factory TasksListEvent.filterTasks(TaskStatus status) = _TasksListEventFilterTasks;
  const factory TasksListEvent.addTask(Task task) = _TasksListEventAddTask;
  const factory TasksListEvent.remove(Task task) = _TasksListEventRemoveTask;
  const factory TasksListEvent.updateTask(Task task) = _TasksListEventUpdateTask;
}